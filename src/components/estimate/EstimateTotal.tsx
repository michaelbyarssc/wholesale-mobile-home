...
import { ShippingCostDisplay } from '@/components/cart/ShippingCostDisplay';
...
interface EstimateTotalProps {
  total: number;
  user: User | null;
  selectedHome?: MobileHome | null;
  deliveryAddress?: DeliveryAddress | null;
}

export const EstimateTotal = ({ total, user, selectedHome, deliveryAddress }: EstimateTotalProps) => {
  return (
    <div className="space-y-4">
      {/* Shipping Cost Display */}
      {selectedHome && deliveryAddress && (
        <ShippingCostDisplay
