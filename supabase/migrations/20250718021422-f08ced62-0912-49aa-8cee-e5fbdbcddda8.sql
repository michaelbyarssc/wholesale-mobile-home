...
BEGIN
  ...
  -- Get the transaction number that was generated
  ...
  -- Create invoice with transaction number (not separate invoice number)
  INSERT INTO public.invoices (
    ...
    estimate_record.id,
    transaction_number_val, -- Use transaction number as invoice number
    estimate_record.customer_name,
    estimate_record.customer_email,
    estimate_record.customer_phone,
    estimate_record.delivery_address,
  ...
  SET 
    ...
    updated_at = now(),
    transaction_number = transaction_number_val
  ...
  RETURN jsonb_build_object(
    ...
    'transaction_number', transaction_number_val,
    'invoice_number', transaction_number_val
  );
END;
$function$;