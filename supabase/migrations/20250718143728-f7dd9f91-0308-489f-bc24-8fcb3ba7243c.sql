-- Fix the trigger_delivery_notifications function to work with delivery_status_history records
...
BEGIN
  -- Get delivery information first
  SELECT estimate_id INTO delivery_info
  FROM deliveries 
  ...
  WHERE o.estimate_id = delivery_info.estimate_id
  LIMIT 1;
