...
CREATE TABLE IF NOT EXISTS public.delivery_gps_tracking (
  ...
  INDEX idx_delivery_gps_delivery_timestamp (delivery_id, timestamp),
  INDEX idx_delivery_gps_driver_timestamp (driver_id, timestamp)
);
...
CREATE TABLE IF NOT EXISTS public.driver_sessions (
  ...
  INDEX idx_driver_sessions_token (session_token),
  INDEX idx_driver_sessions_phone (phone_number),
  INDEX idx_driver_sessions_driver_active (driver_id, active)
);
...
CREATE TABLE IF NOT EXISTS public.delivery_notifications (
  ...
  INDEX idx_delivery_notifications_scheduled (scheduled_for, status),
  INDEX idx_delivery_notifications_delivery (delivery_id),
  INDEX idx_delivery_notifications_type_status (notification_type, status)
);
