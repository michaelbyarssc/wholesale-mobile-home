-- Create remaining tables without RLS first
...
CREATE INDEX IF NOT EXISTS idx_delivery_notifications_scheduled 
  ON public.delivery_notifications(scheduled_for, notification_status);
...
CREATE INDEX IF NOT EXISTS idx_delivery_notifications_type_status 
  ON public.delivery_notifications(notification_type, notification_status);
