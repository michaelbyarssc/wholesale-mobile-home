-- Update the trigger to set initial delivery status as awaiting_delivery_schedule
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    IF new_balance = 0 THEN
      ...
      IF NOT delivery_exists THEN
        ...
        -- Create delivery record with awaiting_delivery_schedule status
        INSERT INTO public.deliveries (
          ...
          home_type,
          crew_type,
          'awaiting_delivery_schedule'::delivery_status, -- Initial status: not scheduled yet
